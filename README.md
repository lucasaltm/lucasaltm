...
- [Extracting email addresses from images using Tesseract OCR, OpenCV and RegEx](https://github.com/lucasaltm/Email_Extractor/blob/main/Extracting_email_adresses.ipynb)
